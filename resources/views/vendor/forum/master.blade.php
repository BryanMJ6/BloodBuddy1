...
<body>
    <br><br><br>
    <nav class="v-navbar navbar navbar-expand-md navbar-light bg-light shadow-sm fixed-top">
        <div class="container">
            <a class="navbar-brand text-danger" href="{{ url('/') }}">BloodBuddy</a>
            ...
            <div class="collapse navbar-collapse" :class="{ show: !isCollapsed }">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('forum.recent') }}">{{ trans('Temas recientes') }}</a>
                    </li>
                    @auth
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('forum.unread') }}">{{ trans('Temas no leídos y actualizados') }}</a>
                        </li>
                    @endauth
                    @can ('moveCategories')
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('forum.category.manage') }}">{{ trans('Administrar') }}</a>
                        </li>
                    @endcan
                ...
                <ul class="navbar-nav">
                    @if (Auth::check())
                        <li class="nav-item dropdown bg-dark">
                            <a class="nav-link dropdown-toggle text-white" href="#" id="navbarDropdownMenuLink" @click="isUserDropdownCollapsed = ! isUserDropdownCollapsed">
                                {{ $username }}
                            </a>
                    ...
                    @else
                        <li class="nav-item">
                            <a class="btn btn-outline-dark" href="{{ url('/login') }}">Iniciar Sesion</a>
                        </li>
                        <li class="nav-item">
                            <a class="btn btn-outline-danger" href="{{ url('/register') }}">Registrarme</a>
                        </li>
                    @endif
                </ul>
            </div>
