...
@extends ('forum::master', ['thread' => null, 'breadcrumbs_append' => [trans('Temas no leidos y Actualizados')]])

@section ('content')
    <div id="new-posts">
        <h2>{{ trans('Temas no leidos y Actualizados') }}</h2>
    ...
    @if (! $threads->isEmpty())
        @can ('markThreadsAsRead')
            <div class="text-center">
                <button class="btn btn-dark px-5" data-open-modal="mark-as-read">
